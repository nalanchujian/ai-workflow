...
export const executableStages = ['requirement-analysis', 'api-analysis', 'design-slicing', 'solution', 'plan', 'development'] as const;
export const requiredExecutableStages = executableStages;
