...
> Historical execution plan: this plan published the `v1.0.0` skills package. The subsequent bundled-method work is recorded in [内置方法依赖实施计划](2026-08-13-内置方法依赖实施计划.md).
